...
$\times$ \emph{proof state}. Experiment 2 holds every surface property fixed
across ten arms while breaking only the logic, and varies entity repetition, line
order and truncation depth alongside a valid-looking certificate whose fabricated
final rule points the wrong way. Experiment 3 scores ten models on a three-class
panel whose \emph{undetermined} items are certified by forward-closure
saturation. Experiment 4 rescores the broken-chain items with a third candidate,
separating detection of an invalid certificate from failure to complete one.
