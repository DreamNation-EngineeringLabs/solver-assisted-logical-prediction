...
alone --- and apply it across four sealed experiments, seventeen model-runs and
$18{,}264$ scored responses, all re-derivable from released receipts.
...
$18{,}264$ responses were scored across seventeen model-runs, with zero
...
is self-contained: sealed panels and answer authorities, all $18{,}264$
...
each receipt carries a SHA-256 of its own contents, and all $18{,}264$
