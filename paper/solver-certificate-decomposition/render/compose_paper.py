...
\textbf{Code and data.} An anonymised repository accompanies this submission at
\url{https://anonymous.4open.science/r/solver-certificate-decomposition}. It
contains the sealed panels and answer authorities, all $12{,}480$ per-response
receipts, the generators, runners, audits and analysis scripts, the
forward-closure certifier with its validation harness, and the figure-rendering
code. A de-anonymised permanent archive with a DOI will replace this link on
acceptance.
